...
# python main.py  --save RCDNet_syn_newfconv --model newfconv_rcdnet --scale 2 \
#     --epochs 100 --batch_size 16 --patch_size 64 --data_train RainHeavy \
#     --n_threads 0 --data_test RainHeavyTest --stage 17 --lr_decay 45 \
#     --gamma 0.2 --num_M 32 --num_Z 32 --data_range 1-200/1-100 \
#     --loss 1*MSE --save_models --device 2
...
python main.py --data_test RainHeavyTest  --ext img --scale 2  --data_range 1-200/1-100 \
    --pre_train ../experiment/RCDNet_syn_newfconv/model/model_best.pt --model newfconv_rcdnet \
    --test_only --save_results --save RCDNet_syn_newfconv --device 2
