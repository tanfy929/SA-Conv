...
from model import PDOe_new as fn
...
#        m_body.append(fn.GroupFusion(n_feats, tranNum))
        ...
        n_feats = n_feats
        m_tail = [
                fn.Fconv_PCA(kernel_size,n_feats,args.n_colors,tranNum,inP=inP,padding=(kernel_size-1)//2,  Smooth = Smooth),
                fn.Fconv_PCA_out(kernel_size,args.n_colors,args.n_colors,tranNum,inP=inP,padding=(kernel_size-1)//2,  Smooth = Smooth)
        ]
