...
class EDSR_e2cnn(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        print(f"@@@@@@@ begin_type:{begin_type}, trivial_repr:{[self.r2_act.trivial_repr]}")
        normal_type = en.FieldType(self.r2_act, n_feats*[self.r2_act.regular_repr]) 
        print(f"%%%%%%% normal_type:{normal_type}, regular_repr:{[self.r2_act.regular_repr]}")
