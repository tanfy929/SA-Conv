### New BConv
python main_train.py --model edsr_newbconv --scale 2 --save edsr_fcnn_retrain_valid --n_resblocks 16 \
    --n_feats 32 --res_scale 0.1 --epoch 150 --decay 100 --patch_size 96 --kernel_size 5 --tranNum 8 --device 4
...
# python main_train.py --model edsr_e2cnn --scale 2 --save Del_EDSR_e2cnn_x2 --n_resblocks 16 --n_feats 32 --res_scale 0.1 --epoch 150 --decay 100 --patch_size 96 --device 6

# python main_train.py --model edsr_plus --scale 2 --save edsr_fcnn_retrain_valid --n_resblocks 16 --n_feats 32 --res_scale 0.1 --epoch 150 --decay 100 --patch_size 96 --kernel_size 5 --tranNum 8 --device 3
